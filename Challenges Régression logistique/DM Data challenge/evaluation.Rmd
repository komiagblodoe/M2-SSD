...
[2] On your local machine, unzip the just downloaded zip file `starting_kit_histology.zip` and open *R* in the unziped `starting_kit_histology` directory, (e.g. open `starting_kit.Rmd` with *RStudio*).
...
- A `submission_script_histology.Rmd` to modify and to use to submit your predictions.
...
The `submission_script_histology.Rmd` script is in charge of this part. 
